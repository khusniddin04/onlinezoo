...
import zoo_img2 from "../images/eagle_active.png";
...
function EagleZoo() {
  return (
    <main>
      <section className='zoo1 zooeagle'>
        <div className="container">
          <div className="zoo1__wrapper">
          <div className="zoo1__left">
              <div className="zoo1_left_card">
                <NavLink  to="/pandas"><img  src={zoo_img} alt="" /></NavLink>
                <p>Pandas</p>
              </div>
              <div className="zoo1_left_card">
                <NavLink to="/eagles"><img className="zoo_img2" src={zoo_img2} alt="" /></NavLink>
                <p>Eagles</p>
              </div>
              <div className="zoo1_left_card">
            ...
            <div className="zoo1__right">
              <Top title="eagles" text="Main cameras"/>
              <div className="zoo1_right_video">
              <iframe className="panda_iframe" src="https://www.youtube.com/embed/XsB-wC24XGc" title="The Most Amazing Eagle Attacks Ever Caught on Camera" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              </div>
